...
class SongViewModel(application: Application) : AndroidViewModel(application) {
    ...
    companion object {
        ...
        const val SERVER_URI = "https://expresssongdb-vfdlq.run.goorm.io"
    }
    ...
    fun getImageUri(i: Int): String = "$SERVER_URI/image/" + URLEncoder.encode(songs[i].image, "utf-8");
    fun requestSong() {
        // NOTE: 서버 주소는 본인의 서버 IP 사용할 것
       // val url = "https://expresssongdb-vfdlq.run.goorm.io/"

        //Array 반환할 경우에는 JsonObjectRequest 대신 JsonArrayRequest 사용
